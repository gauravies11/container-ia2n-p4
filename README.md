...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ia2n-p4.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ia2n-p4.containers.anotherwebservice.com/
...
```
git clone git@github.com:gauravies11/container-ia2n-p4.git
cd container-ia2n-p4
```
...
```
docker attach container-ia2n-p4
```
